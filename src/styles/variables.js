...
export const pinkTheme = {
  background_color: colors.themecolorPinkLight,
  header_paragraph_color: colors.themecolorPink,
  heading_color: colors.themecolorBlue,
  text_color: colors.themecolor,
  btn_color: colors.themecolorPink,
};
